...
#define KnopS0Mask 0x01
#define KnopS1Mask 0x02
#define KnopS2Mask 0x04
#define KnopS3Mask 0x08
...
void berekenMetSamples(){
    ...
    if ((KNOP_Read() & KnopS0Mask) == 0b00000001) {
        sampleUit[LINKS] = 0;
    } else {
       sampleUit[LINKS] = sampleIn[LINKS]; 
    }
    
    if ((KNOP_Read() & KnopS1Mask) == 0b00000010) {
        sampleUit[RECHTS] = 0;
    } else {
