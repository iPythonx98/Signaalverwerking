...
*
* \funcusage
*  \snippet AudioCodecClk_SUT.c usage_AudioCodecClk_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet AudioCodecClk_SUT.c usage_AudioCodecClk_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet AudioCodecClk_SUT.c usage_AudioCodecClk_Read  
*******************************************************************************/
...
* preferred AudioCodecClk_Read() API because the 
* AudioCodecClk_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet AudioCodecClk_SUT.c usage_AudioCodecClk_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: AudioCodecClk_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use AudioCodecClk_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - AudioCodecClk_0_INTR       (First pin in the list)
    *  - AudioCodecClk_1_INTR       (Second pin in the list)
    *  - ...
    *  - AudioCodecClk_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet AudioCodecClk_SUT.c usage_AudioCodecClk_SetInterruptMode
    *******************************************************************************/
    void AudioCodecClk_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & AudioCodecClk_0_INTR) != 0u) 
		{ 
			 AudioCodecClk_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet AudioCodecClk_SUT.c usage_AudioCodecClk_ClearInterrupt
    *******************************************************************************/
