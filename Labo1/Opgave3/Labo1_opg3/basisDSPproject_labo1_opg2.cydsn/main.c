...
#define KnopMask1 0x01
#define KnopMask2 0x02
#define KnopMask3 0x04
#define KnopMask4 0x08
...
void berekenMetSamples(){
    if((KNOP_TOGGLE_Read() & KnopMask1) == KnopMask1) {
        sampleUit[LINKS] = sampleIn[RECHTS];
        sampleUit[RECHTS] = sampleIn[LINKS];
