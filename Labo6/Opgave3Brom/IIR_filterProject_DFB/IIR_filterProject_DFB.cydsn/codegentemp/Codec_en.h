...
void    Codec_en_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Codec_en_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Codec_en__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Codec_en_SetInterruptMode() function.
     *  @{
     */
        #define Codec_en_INTR_NONE      (uint16)(0x0000u)
        #define Codec_en_INTR_RISING    (uint16)(0x0001u)
        #define Codec_en_INTR_FALLING   (uint16)(0x0002u)
        #define Codec_en_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Codec_en_INTR_MASK      (0x01u) 
#endif /* (Codec_en__INTSTAT) */
...
/* SIO registers */
#if defined(Codec_en__SIO_CFG)
    #define Codec_en_SIO_HYST_EN        (* (reg8 *) Codec_en__SIO_HYST_EN)
    #define Codec_en_SIO_REG_HIFREQ     (* (reg8 *) Codec_en__SIO_REG_HIFREQ)
    #define Codec_en_SIO_CFG            (* (reg8 *) Codec_en__SIO_CFG)
    #define Codec_en_SIO_DIFF           (* (reg8 *) Codec_en__SIO_DIFF)
#endif /* (Codec_en__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Codec_en_0_INTTYPE_REG 		(* (reg8 *) Codec_en__0__INTTYPE)
#endif /* (Codec_en__INTSTAT) */
