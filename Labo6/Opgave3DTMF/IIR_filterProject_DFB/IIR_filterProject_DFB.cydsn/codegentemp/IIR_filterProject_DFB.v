...
module top ;
    ...
    OpAmp_v1_90_5 AnalogeIngang_R (
        .Vplus(Net_1079),
        .Vout(Net_1080),
        .Vminus(Net_1081));
    defparam AnalogeIngang_R.Mode = 1;

	wire [0:0] tmpOE__AnR_uit_net;
	wire [0:0] tmpFB_0__AnR_uit_net;
	wire [0:0] tmpIO_0__AnR_uit_net;
	wire [0:0] tmpINTERRUPT_0__AnR_uit_net;
	electrical [0:0] tmpSIOVREF__AnR_uit_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		AnR_uit
		 (.oe(tmpOE__AnR_uit_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AnR_uit_net[0:0]}),
		  .analog({Net_1080}),
		  .io({tmpIO_0__AnR_uit_net[0:0]}),
		  .siovref(tmpSIOVREF__AnR_uit_net),
		  .interrupt({tmpINTERRUPT_0__AnR_uit_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AnR_uit_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AnR_in_net;
	wire [0:0] tmpFB_0__AnR_in_net;
	wire [0:0] tmpIO_0__AnR_in_net;
	wire [0:0] tmpINTERRUPT_0__AnR_in_net;
	electrical [0:0] tmpSIOVREF__AnR_in_net;

	cy_psoc3_pins_v1_10
		#(.id("6269f9d5-f80d-4c32-97cb-4b6ae4d00b55"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AnR_in
		 (.oe(tmpOE__AnR_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AnR_in_net[0:0]}),
		  .analog({Net_1079}),
		  .io({tmpIO_0__AnR_in_net[0:0]}),
		  .siovref(tmpSIOVREF__AnR_in_net),
		  .interrupt({tmpINTERRUPT_0__AnR_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AnR_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    OpAmp_v1_90_6 AnalogeIngang_L (
        .Vplus(Net_1082),
        .Vout(Net_1083),
        .Vminus(Net_1084));
    defparam AnalogeIngang_L.Mode = 1;

	wire [0:0] tmpOE__AnL_uit_net;
	wire [0:0] tmpFB_0__AnL_uit_net;
	wire [0:0] tmpIO_0__AnL_uit_net;
	wire [0:0] tmpINTERRUPT_0__AnL_uit_net;
	electrical [0:0] tmpSIOVREF__AnL_uit_net;

	cy_psoc3_pins_v1_10
		#(.id("d55e2294-1570-443b-9b08-d34e7c7c6d23"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AnL_uit
		 (.oe(tmpOE__AnL_uit_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AnL_uit_net[0:0]}),
		  .analog({Net_1083}),
		  .io({tmpIO_0__AnL_uit_net[0:0]}),
		  .siovref(tmpSIOVREF__AnL_uit_net),
		  .interrupt({tmpINTERRUPT_0__AnL_uit_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AnL_uit_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AnL_in_net;
	wire [0:0] tmpFB_0__AnL_in_net;
	wire [0:0] tmpIO_0__AnL_in_net;
	wire [0:0] tmpINTERRUPT_0__AnL_in_net;
	electrical [0:0] tmpSIOVREF__AnL_in_net;

	cy_psoc3_pins_v1_10
		#(.id("c238d539-65e6-4513-a764-ab5dc603fabc"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AnL_in
		 (.oe(tmpOE__AnL_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AnL_in_net[0:0]}),
		  .analog({Net_1082}),
		  .io({tmpIO_0__AnL_in_net[0:0]}),
		  .siovref(tmpSIOVREF__AnL_in_net),
		  .interrupt({tmpINTERRUPT_0__AnL_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AnL_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Filter_v2_30_7 Filter (
        .DMA_Req_A(Net_1158),
        .DMA_Req_B(Net_1159),
        .Interrupt(Net_1160));
