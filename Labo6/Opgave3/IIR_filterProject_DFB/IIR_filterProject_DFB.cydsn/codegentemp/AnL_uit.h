...
void    AnL_uit_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the AnL_uit_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(AnL_uit__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in AnL_uit_SetInterruptMode() function.
     *  @{
     */
        #define AnL_uit_INTR_NONE      (uint16)(0x0000u)
        #define AnL_uit_INTR_RISING    (uint16)(0x0001u)
        #define AnL_uit_INTR_FALLING   (uint16)(0x0002u)
        #define AnL_uit_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define AnL_uit_INTR_MASK      (0x01u) 
#endif /* (AnL_uit__INTSTAT) */
...
/* SIO registers */
#if defined(AnL_uit__SIO_CFG)
    #define AnL_uit_SIO_HYST_EN        (* (reg8 *) AnL_uit__SIO_HYST_EN)
    #define AnL_uit_SIO_REG_HIFREQ     (* (reg8 *) AnL_uit__SIO_REG_HIFREQ)
    #define AnL_uit_SIO_CFG            (* (reg8 *) AnL_uit__SIO_CFG)
    #define AnL_uit_SIO_DIFF           (* (reg8 *) AnL_uit__SIO_DIFF)
#endif /* (AnL_uit__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define AnL_uit_0_INTTYPE_REG 		(* (reg8 *) AnL_uit__0__INTTYPE)
#endif /* (AnL_uit__INTSTAT) */
