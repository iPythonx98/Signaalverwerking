...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the CLIP_LED_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(CLIP_LED__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in CLIP_LED_SetInterruptMode() function.
     *  @{
     */
        #define CLIP_LED_INTR_NONE      (uint16)(0x0000u)
        #define CLIP_LED_INTR_RISING    (uint16)(0x0001u)
        #define CLIP_LED_INTR_FALLING   (uint16)(0x0002u)
        #define CLIP_LED_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define CLIP_LED_INTR_MASK      (0x01u) 
#endif /* (CLIP_LED__INTSTAT) */
...
/* SIO registers */
#if defined(CLIP_LED__SIO_CFG)
    #define CLIP_LED_SIO_HYST_EN        (* (reg8 *) CLIP_LED__SIO_HYST_EN)
    #define CLIP_LED_SIO_REG_HIFREQ     (* (reg8 *) CLIP_LED__SIO_REG_HIFREQ)
    #define CLIP_LED_SIO_CFG            (* (reg8 *) CLIP_LED__SIO_CFG)
    #define CLIP_LED_SIO_DIFF           (* (reg8 *) CLIP_LED__SIO_DIFF)
#endif /* (CLIP_LED__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define CLIP_LED_0_INTTYPE_REG 		(* (reg8 *) CLIP_LED__0__INTTYPE)
#endif /* (CLIP_LED__INTSTAT) */
