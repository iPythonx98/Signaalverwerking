...
*
* \funcusage
*  \snippet AnL_in_SUT.c usage_AnL_in_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet AnL_in_SUT.c usage_AnL_in_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet AnL_in_SUT.c usage_AnL_in_Read  
*******************************************************************************/
...
* preferred AnL_in_Read() API because the 
* AnL_in_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet AnL_in_SUT.c usage_AnL_in_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: AnL_in_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use AnL_in_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - AnL_in_0_INTR       (First pin in the list)
    *  - AnL_in_1_INTR       (Second pin in the list)
    *  - ...
    *  - AnL_in_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet AnL_in_SUT.c usage_AnL_in_SetInterruptMode
    *******************************************************************************/
    void AnL_in_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & AnL_in_0_INTR) != 0u) 
		{ 
			 AnL_in_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet AnL_in_SUT.c usage_AnL_in_ClearInterrupt
    *******************************************************************************/
