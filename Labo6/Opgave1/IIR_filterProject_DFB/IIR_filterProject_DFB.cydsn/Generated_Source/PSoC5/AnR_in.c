...
*
* \funcusage
*  \snippet AnR_in_SUT.c usage_AnR_in_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet AnR_in_SUT.c usage_AnR_in_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet AnR_in_SUT.c usage_AnR_in_Read  
*******************************************************************************/
...
* preferred AnR_in_Read() API because the 
* AnR_in_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet AnR_in_SUT.c usage_AnR_in_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: AnR_in_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use AnR_in_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - AnR_in_0_INTR       (First pin in the list)
    *  - AnR_in_1_INTR       (Second pin in the list)
    *  - ...
    *  - AnR_in_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet AnR_in_SUT.c usage_AnR_in_SetInterruptMode
    *******************************************************************************/
    void AnR_in_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & AnR_in_0_INTR) != 0u) 
		{ 
			 AnR_in_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet AnR_in_SUT.c usage_AnR_in_ClearInterrupt
    *******************************************************************************/
